        ...
        return newReceiveBuilder()
                .onMessage(StartCommand.class, message -> {
                    ...
                    return Behaviors.withTimers(timer -> {
                        timer.startTimerAtFixedRate(TIMER_KEY, new GetPositionsCommand(), Duration.ofSeconds(1)); //future where are you messages?
...
//                    currentPositions.keySet().stream().forEach(racer -> {
